...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" type="image/png" href="assets/uploads/favicon1.png">
	...
	<div class="container">
		<div class="row inner">
			<div class="col-md-8 logo">
				<a href="index.php"><img src="assets/uploads/logo1.png" alt="logo image"></a>
			</div>
			...
			<div class="col-md-5 right">
				<ul>
					...
					<li><a href="cart.php"><i class="fa fa-shopping-cart"></i> (<?php
...
<div class="nav"  style="background-color: #8171AA;">
	<div class="container">
		<div class="row" >
			<div class="col-md-12 pl_0 pr_0">
				<div class="menu-container" style="background-color: #8171AA;">
					<div class="menu">
						<ul>
							...
							foreach ($result as $row) {
								?>
								<li><a href="product-category.php?id=<?php echo $row['ecat_id']; ?>&type=end-category"><?php echo $row['ecat_name']; ?></a>
