...
*/
    ...
    if($path!='') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
            $valid = 0;
            $error_message .= 'You have to upload jpg, jpeg, gif or png file<br>';
        }
    } else {
    	$valid = 0;
        $error_message .= 'You have to select a featured photo<br>';
    }
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<strong class="card-title" v-if="headerText">Add Product</strong>
				...
				<div class="box box-info">
					<div class="card-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="ecat_id" class="form-control select2 top-cat">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Price <span>*</span> <span></span><span style="font-size:10px;font-weight:normal;">TND</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea name="p_short_description" class="form-control" cols="15" rows="2" id="editor2"></textarea>
							</div>
						</div>
